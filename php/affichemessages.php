...
<?php   
 include ("./inc/header.inc.php"); headerinclude ("mess_php"); 
  include ("inc/cookie.inc.php"); cookieinclude ("mess_php");
...
<?php 
 ...
 require("inc/connexion.inc.php"); AfficheReqBddTAB($requete) ;
?>     
