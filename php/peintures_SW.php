...
<html lang="fr">
  <head>
	...
	<![endif] -->
	<title> MYSTERES ET ILLUSIONS - PEINTURES DE STEPHEN WILTSHIRE </title>
	<meta charset="utf-8"/>
...
?>
 <img src="../img/mysteres/sw2.jpg" id="imageenhaut"  >	
</header>
...
<aside>
<?php
 include ("inc/cookie.inc.php"); cookieinclude ("peinturesSW");
?>
</aside>
...
<!-- menu navigation mobile -->
 ...
 <?php  
  ...
  ?>
    ...
    <article>
	  <h1>
	  <a href ="./lignes_nazca.php"> <img src="../img/f_gauche.png" id="flechegauche" ></a>
  	  Les peintures de SW
      ...
      <article>
  	  ...
  	  <a href ="../img/mysteres/swnewyork.jpg" > <img src="../img/mysteres/swnewyork.jpg" id="imagearticle" alt="peinture Steven Wiltshire"/></a>
...
<footer>
<?php   
 include ("./inc/footer.inc.php");  footerinclude ("peinturesSW"); 
?>
</footer>
