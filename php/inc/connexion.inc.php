...
function AffListUserTAB($requete, $requete3, $requete4) { 
    /* Declaration des variables de connexion a la BDD  */
...
if ( $_SERVER['HTTP_HOST'] == 'mystillus.hol.es' ){
  ...
  $resultat2 = mysqli_num_rows($resultat1);  
  $resultat3 = rendvaleur ($requete3);  
  $resultat4 = rendvaleur ($requete4); ?>
  
   nombre de comptes: <?php echo $resultat2 ;?> <br />
   id min: <?php echo $resultat3 ;?> <br />
   id max: <?php echo $resultat4 ;?> <br /> 
